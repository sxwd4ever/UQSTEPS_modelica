...
model RCBCycleConfig
  ...
  parameter ThermoState st_recomp_out(
    p = p_comp_out,
    T = T_LTR_cold_out, 
    h = medium_main.specificEnthalpy_pT(p = p_comp_out, T = T_LTR_cold_out), 
    mdot = mdot_bypass
    );      
  ...
  parameter Model.HeatExchangerConfig cfg_cooler(
    cfg_hot(
      ...
      geo_area = SetAreaGeometry_Circle(r = r_i_cooler, L = L_cooler),
      geo_path = SetPathGeometry_Circle(r = r_i_cooler, L = L_cooler, N_seg = N_seg_cooler),
      N_ch     = N_ch_cooler,
      u        = 0
    ),
    cfg_cold(
      ...
      geo_area = SetAreaGeometry_Circle(r = r_o_cooler, L = L_cooler),
      geo_path = SetPathGeometry_Circle(r = r_o_cooler, L = L_cooler, N_seg = N_seg_cooler),
      N_ch     = N_ch_cooler,
      u        = 0
    ),
    cfg_wall(
      st_init  = st_cooler_hot_in,
      geo_area = SetAreaGeometry_Circle(r = r_t_cooler, L = L_cooler),
      geo_wall = SetPathGeometry_Circle(r = r_t_cooler, L = L_cooler, N_seg = N_seg_cooler),
  ...
  parameter Model.HeatExchangerConfig cfg_LTR(
    cfg_hot(
      ...
      geo_area = SetAreaGeometry_Circle(r = r_i_LTR, L = L_LTR),
      geo_path = SetPathGeometry_Circle(r = r_i_LTR, L = L_LTR, N_seg = N_seg_LTR),
      N_ch     = N_ch_LTR,
      u        = 0
    ),
    cfg_cold(
      ...
      geo_area = SetAreaGeometry_Circle(r = r_o_LTR, L = L_LTR),
      geo_path = SetPathGeometry_Circle(r = r_o_LTR, L = L_LTR, N_seg = N_seg_LTR),
      N_ch     = N_ch_LTR,
      u        = 0
    ),
    cfg_wall(
      st_init  = st_LTR_hot_in,
      geo_area = SetAreaGeometry_Circle(r = r_t_LTR, L = L_LTR),
      geo_wall = SetPathGeometry_Circle(r = r_t_LTR, L = L_LTR, N_seg = N_seg_LTR),
  ...
  parameter Modelica.SIunits.Radius r_i_HTR = 100e-3 "mm tube's internal radius";
  parameter Modelica.SIunits.Radius r_t_HTR = 110e-3 "tube's external radius";
  parameter Modelica.SIunits.Radius r_o_HTR = 170e-3 "radius of external side of one group";
  ...
  parameter Model.HeatExchangerConfig cfg_HTR(
    cfg_hot(
      ...
      geo_area = SetAreaGeometry_Circle(r = r_i_HTR, L = L_HTR),
      geo_path = SetPathGeometry_Circle(r = r_i_HTR, L = L_HTR, N_seg = N_seg_HTR),
      N_ch     = N_ch_HTR,
      u        = 0
    ),
    cfg_cold(
      ...
      geo_area = SetAreaGeometry_Circle(r = r_o_HTR, L = L_HTR),
      geo_path = SetPathGeometry_Circle(r = r_o_HTR, L = L_HTR, N_seg = N_seg_HTR),
      N_ch     = N_ch_HTR,
      u        = 0
    ),
    cfg_wall(
      st_init  = st_HTR_hot_in,
      geo_area = SetAreaGeometry_Circle(r = r_t_HTR, L = L_HTR),
      geo_wall = SetPathGeometry_Circle(r = r_t_HTR, L = L_HTR, N_seg = N_seg_HTR),
  ...
  parameter Model.HeatExchangerConfig cfg_heater(
    cfg_hot(
      ...
      geo_area = SetAreaGeometry_Circle(r = r_i_heater, L = L_heater),
      geo_path = SetPathGeometry_Circle(r = r_i_heater, L = L_heater, N_seg = N_seg_heater),
      N_ch     = N_ch_heater,
      u        = 0
    ),
    cfg_cold(
      ...
      geo_area = SetAreaGeometry_Circle(r = r_o_heater, L = L_heater),
      geo_path = SetPathGeometry_Circle(r = r_o_heater, L = L_heater, N_seg = N_seg_heater),
      N_ch     = N_ch_heater,
      u        = 0
    ),
    cfg_wall(
      st_init  = st_heater_hot_in,
      geo_area = SetAreaGeometry_Circle(r = r_t_heater, L = L_heater),
      geo_wall = SetPathGeometry_Circle(r = r_t_heater, L = L_heater, N_seg = N_seg_heater),
      table_k  = table_k_heater_wall,
      rho_mcm  = rho_wall * cp_wall,
      lambda   = 200
    )    
