...
*/
  Steps.TPComponents.PCHE HTR(
    ...
    gasFlow(
      QuasiStatic = true,
      Tstartin    = cfg_HTR.cfg_hot.st_in.T,
      Tstartout   = cfg_HTR.cfg_hot.st_out.T,
      heatTransfer(
    ...
    fluidFlow(
      QuasiStatic = true,
      Tstartin    = cfg_HTR.cfg_cold.st_in.T,
      Tstartout   = cfg_HTR.cfg_cold.st_out.T,
      heatTransfer(
  ...
  Steps.TPComponents.PCHE LTR(
    ...
    gasFlow(
      QuasiStatic = true,
      Tstartin    = cfg_LTR.cfg_hot.st_in.T,
      Tstartout   = cfg_LTR.cfg_hot.st_out.T,
      heatTransfer(
    ...
    fluidFlow(
      QuasiStatic = true,
      Tstartin    = cfg_LTR.cfg_cold.st_in.T,
      Tstartout   = cfg_LTR.cfg_cold.st_out.T,
      heatTransfer(
