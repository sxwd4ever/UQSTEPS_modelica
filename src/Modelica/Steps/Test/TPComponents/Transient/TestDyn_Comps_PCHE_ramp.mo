...
/*
  ...
  Modelica.Blocks.Sources.IntegerConstant const_T_offset_h(k = integer(cfg_HTR.cfg_hot.st_in.T)) annotation(
  ...
  // cold/fluid side
  Modelica.Blocks.Sources.IntegerConstant const_T_offset_c(k = integer(cfg_LTR.cfg_cold.st_in.T)) annotation(
