...
model TestDyn_PCHE_PHE_ramp
  "Test for ThermoPower based PCHE model against Pinjarra Hill Experimental Data"  
  ...
  parameter SI.Pressure p_cold_in = 9.819727e6 "cold inlet pressure";
  parameter SI.Temperature T_hot_in = from_degC(48.220577) "hot inlet temperature, K";
  parameter SI.Temperature T_hot_out = from_degC(39.894208) "cold outlet temperature, K";
  parameter SI.Temperature T_cold_in = from_degC(22.156752) "cold inlet temperature, K";
  parameter SI.Temperature T_cold_out = from_degC(45.074215) "cold outlet temperature, K";
...
*/   
  ...
  connect(tt_T_hot_in.y, source_hot.in_T);
