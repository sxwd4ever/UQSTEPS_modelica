...
*/  
  ...
  Steps.TPComponents.PCHE HE(
    ...
    redeclare replaceable model HeatTransfer_F = ThermoPower.Thermal.HeatTransferFV.ConstantHeatTransferCoefficient(gamma =1000),     
    redeclare replaceable model HeatTransfer_G = ThermoPower.Thermal.HeatTransferFV.ConstantHeatTransferCoefficientTwoGrids(gamma = 1000),     
    ...
    */ 
    ...
    //Nominal parameter
    gasNomFlowRate = 100,
    fluidNomFlowRate = 100,
    gasNomPressure = from_bar(90),
    fluidNomPressure = from_bar(225),
    //Physical Parameter
    exchSurface_G = 100,
    exchSurface_F = 100,
    extSurfaceTub = 100,
    ...
    Tstartbar_G = 730,
    Tstartbar_F = 500,
    pstart_G = from_bar(90),    
    Tstartbar_M = 680,
    pstart_F = from_bar(225),
    */    
    L = L_fp,
    SSInit = true,
