within Steps.Media;
package Oil "generic Oil for heat process"

  extends Modelica.Media.Interfaces.PartialMedium(ThermoStates = Modelica.Media.Interfaces.Choices.IndependentVariables.ph, final mediumName = "Oil", final substanceNames = {"Oil"}, final singleState = false, final reducedX = true, final fixedX = true, Temperature(min = 20, max = 873.15, start = 500));
  ...
  model MockOil "Base properties of medium"
